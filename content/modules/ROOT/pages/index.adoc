...
Module 1 covers the technical details of what causes tail latency and how llm-d addresses it.
...
**Outcome**: Working model deployment and understanding that scaling for capacity ≠ scaling for latency.
...
* Run GuideLLM benchmarks to measure throughput and latency
