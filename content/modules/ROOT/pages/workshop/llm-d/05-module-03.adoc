...
Run the same benchmark you performed at the end of Module 2,
now against the scaled deployment with our custom service:
...
Despite that, our TTFT numbers are not looking freat. Around four seconds for the first token for our slowest 5% of queries, the bottom 1/20th!
...
* Tail latency (P95): 4 GPUs = minimal or NO improvement ❌
